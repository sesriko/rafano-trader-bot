# ============================================================
# RAFANO TRADER V9.11 - UPDATED WITH CORRECT BROKER SUMMARY ENDPOINT
# ============================================================
...
# ============================================================
# 1. MARKET DATA PROVIDER (CORRECTED ENDPOINTS)
# ============================================================
...
class MarketDataProvider:
    ...
    async def fetch_all_market_data(cls, ticker: str) -> Dict[str, Any]:
        ...
        # Menggunakan endpoint broker-summary yang valid sesuai contoh curl Anda
        urls = {
...
# ============================================================
# 2. DATA STRUCTURE & PARSERS FOR BROKER SUMMARY
# ============================================================
...
def parse_broker_summary(data: Optional[Dict[str, Any]]) -> str:
    ...
    if isinstance(payload, dict):
        buyers = payload.get("top_buyers", payload.get("buyers", []))
...
def main():
    ...
    logger.info("Rafano Trader Bot V9.11 is running...")
    app.run_polling()
